              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" id="password-change-form" method="POST">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="newpassword" placeholder="enter new pasword">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputExperience" class="col-sm-2 col-form-label">Confirm New Password</label>
                            <div class="col-sm-10">
                            <textarea class="form-control" id="cnewpassword" placeholder="Re-enter new password"></textarea>
                            </div>
                        </div>
